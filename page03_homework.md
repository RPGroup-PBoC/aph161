...
Submission policy: Submit all write-ups as PDFs and all Jupyter code as **both** .ipynb and .html files. Your written solutions should be clear and understandable throughout so that we can follow your reasoning. Submit your HW on Canvas, through Gradescope. Extension requests have to be sent 6 hours before homework is due, everything after that will be regarded as late. Late submission are deducted 10% of points, increasing by 10% for every hour after  4pm.
